...
@section("content")
  ...
  <section class="mt-5">
    <div class="container" data-aos="fade-up" data-aos-duration="500">
      <h3 class="text-center" style="font-weight: 700">Desa Janju <hr class="bg-primary m-auto" style="width:20%; height:2px"></h3>
      ...
      <p class="text-justify" style="font-size: 15px">
        ...
        <ol class="mx-5" style="font-size: 15px">
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12">
                <div class="cta">
                    ...
                    <h3 class="text-center" style="letter-spacing: 8px; line-height: 0; font-weight:900">VISI</h3>
                    <p style="font-size: 20px; font-weight:500;"><i>“Mewujudkan Desa Janju yang Mandiri , Sejahtera dan Demokratis”</i></p>
                    <br>
                    <h3 class="text-center" style="letter-spacing: 8px; line-height: 0; font-weight:900">MISI</h3>
                    <ul style="color: white;">
                        <li>
                            <p style="font-size: 20px; font-weight:500;"><i>“Meningkatkan Sumber Daya Manusia agar mempunyai wawasan yang luas.”</i></p>
                        </li>
                        <li>
                            <p style="font-size: 20px; font-weight:500;"><i>“Penyelenggaraan Pemerintahan Desa yang bersih dan berwibawa.”</i></p>
                        </li>
                        <li>
                            <p style="font-size: 20px; font-weight:500;"><i>“Mengembangkan sikap kegotong royongan masyarakat dalam pembangunan.”</i></p>
                        </li>
                        <li>
                            <p style="font-size: 20px; font-weight:500;"><i>“Meningkatkan ekonomi masyarakat dengan membudayakan kemitraan dengan pelaku pembangunan lain.”</i></p>
                        </li>
                    </ul>
                </div>
            </div>
  ...
  <section>
    <div class="container" data-aos="fade-up" data-aos-duration="500">
      <h3 class="text-center" style="font-weight: 700">Struktur Pemerintahan Desa Janju <hr class="bg-primary m-auto" style="width:20%; height:2px"></h3>
      <img src="{{ asset("storage/struktur_organisasi/" . $struktur_organisasi) }}" class="img-fluid">
    </div>
    <!--end of container-->
  </section>

  <section class="imagebg" data-gradient-bg='#A2D2FF,#1363DF,#47B5FF,#1F4690,#7FB5FF,#11468F'>
    <h3 class="text-center" style="font-weight: 700" data-aos="fade-up" data-aos-duration="500">Demografi Desa Janju <hr class="bg-light m-auto" style="width:20%; height:2px"></h3>
    <div class="container" data-aos="fade-up" data-aos-duration="500">
      <div class="row">
        <p class="text-justify" style="font-size: 15px">
