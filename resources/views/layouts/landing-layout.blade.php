...
<html lang="en">
    ...
    <body class=" ">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-11 col-md-12 text-right text-left-xs text-left-sm">
                            ...
                            <!--end module-->
                            <div class="bar__module">
                                <a class="btn btn--sm btn--primary type--uppercase" href="{{ asset('template') }}#">
                                    <span class="btn__text">
                                      Login
                                    </span>
                                </a>
        ...
        <a class="back-to-top inner-link" href="{{ asset('template') }}#/start" data-scroll-class="100vh:active">
